...
public class LoginModule {
				...
				System.out.println("Facebook Nick Name:   " + currentNickName);
						...
						// Condition = Username: provided + Password: provided + Expected Result: Test Passed + Logout: True.		
							...
							//Appium code
							  ...
							  wait.until(ExpectedConditions.presenceOfElementLocated(By.id("com.thankyo.hwgame:id/me_tv_login_name_new"))).getText();
	...
	/*
	 * 
	 * @Test public void streamkarGoogleLogintest() throws InterruptedException
	 * {
	 * 
	 * //Skip Button
	 * wait.until(ExpectedConditions.presenceOfElementLocated(By.id(
	 ...
	 * //Google Button
	 * wait.until(ExpectedConditions.presenceOfElementLocated(By.id(
	 * "com.thankyo.hwgame:id/button2"))).click();
	 * 
	 * //Choose Google Account For Streamkar
	 * wait.until(ExpectedConditions.presenceOfElementLocated(By.id(
	 * "com.google.android.gms:id/account_display_name"))).click();
	 * 
	 * //Clicking In The Middle Of The Screen
	 * wait.until(ExpectedConditions.presenceOfElementLocated(By.id(
	 * "com.thankyo.hwgame:id/room_list_item1_image"))).click();
